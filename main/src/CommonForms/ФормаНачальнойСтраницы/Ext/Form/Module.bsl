...
&НаКлиенте
Процедура ИзменитьФактическийЛимит(Команда)
	
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("ТекущийОстатокЛимита", ФактическийОстатокЛимита);
	
	ОткрытьФорму("РегистрСведений.ОстатокЛимитаДенежныхСредств.Форма.ФормаРедактированияЛимита", ПараметрыФормы);
