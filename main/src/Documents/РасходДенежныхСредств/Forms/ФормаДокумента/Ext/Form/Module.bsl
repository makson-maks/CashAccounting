...
Процедура УправлениеФормой()
	...
	Элементы.ГруппаПовторяемыеСобытия.Видимость = Объект.ВидРасхода = Перечисления.ВидыРасходов.Планируемый;
	Элементы.КоличествоДнейДляПовторения.Видимость = Объект.ПовторяемоеСобытие;
	Элементы.ДатаОкончанияПовторяемыхСобытий.Видимость = Объект.ПовторяемоеСобытие;
