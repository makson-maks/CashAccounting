...
&НаКлиенте
Процедура УдалитьВсеПовторяющиесяСобытия(Команда)
	УдалитьВсеПовторяющиесяСобытияСервер();
КонецПроцедуры
...
Процедура СписокПриАктивизацииСтроки(Элемент)
	...
	Если ТекущиеДанные <> Неопределено Тогда
		ЭтоПлановыйРасход = ТекущиеДанные.ВидРасхода = ПредопределенноеЗначение("Перечисление.ВидыРасходов.Планируемый");	
		Элементы.СписокКонтекстноеМенюУдалитьВсеПовторяющиесяСобытия.Видимость = ЭтоПлановыйРасход;
	КонецЕсли;
...
&НаСервере
Процедура УдалитьВсеПовторяющиесяСобытияСервер()
	
	ТекущаяСтрока = Элементы.Список.ТекущаяСтрока;
	Если ТекущаяСтрока <> Неопределено Тогда
		Документы.РасходДенежныхСредств.УдалитьВсеПовторяющиеСобытияПоДанномуОснованию(ТекущаяСтрока.УИДПовторяемыхСобытий, Неопределено);
