...
Контекст:
    ...
    Добавление лимита
        Когда В панели разделов я выбираю 'Учет денежных средств'
        И Я нажимаю кнопку командного интерфейса 'Лимит денежных средств'
...
Сценарий: Проверка текущих остатков
    ...
    Проверка остатков
        Когда В панели разделов я выбираю 'Учет денежных средств'
        И Я нажимаю кнопку командного интерфейса 'Открыть форму начальной страницы'
