...
Сценарий: Проверка текущих остатков
    ...
    Проверка остатков
        ...
        И элемент формы с именем "ПлановыйОстатокЛимита" стал равен '12 000'                        
    ...
    Проверка остатков
        ...
        Тогда элемент формы с именем "ТекущийОстатокДенежныхСредств" стал равен '12 000'
        И элемент формы с именем "ФактическийОстатокЛимита" стал равен '12 000'
        И элемент формы с именем "ПлановыйОстатокЛимита" стал равен '9 400'
    ...
    Проверка остатков
        ...
        Тогда элемент формы с именем "ТекущийОстатокДенежныхСредств" стал равен '12 000'
        И элемент формы с именем "ФактическийОстатокЛимита" стал равен '12 000'
        И элемент формы с именем "ПлановыйОстатокЛимита" стал равен '8 000'
    ...
    Проверка остатков
        ...
        И элемент формы с именем "ФактическийОстатокЛимита" стал равен '8 500'
        И элемент формы с именем "ПлановыйОстатокЛимита" стал равен '8 500'
